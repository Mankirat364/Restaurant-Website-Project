...
import reviewImg_1 from '../../../assets/reviewer-1.png';
      ...
      <div className="container mt-md-5 pt-md-5 shop-details-page">
        <div className="row">
          ...
          <div className="col-12 col-md-6 right-section">
            ...
            <hr />
            <p className='details-para'>Aliquam hendrerit a augue insuscipit. Etiam aliquam massa quis des mauris commodo venenatis ligula commodo leez sed blandit convallis dignissim onec vel pellentesque neque.S</p>
            ...
            <div className="share-friends">
              ...
              <div className="share-friend">
                <div className="share-friends-icons">
                  <FaFacebookF />
                </div>
                <div className="share-friends-icons">
                  <FaInstagramSquare />
        ...
        <div className="product-description">
          ...
          <p className='details-para'>Neque porro est qui dolorem ipsum quia quaed inventor veritatis et quasi architecto beatae vitae dicta sunt explicabo. Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros. Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br /><br />
        ...
        <div className="review-form">
          ...
          <textarea placeholder="Your Review" className="review-textarea">
